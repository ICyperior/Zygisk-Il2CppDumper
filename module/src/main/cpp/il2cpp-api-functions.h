...
DO_API(const char*, _ZSt20r, (Il2CppClass * klass));
...
DO_API(const Il2CppType*, _ZNSt27gvEl, (Il2CppClass * klass));
DO_API(bool, _ZNKSt28fP, (const Il2CppClass * klass));
// domain
DO_API(Il2CppDomain*, _Znwm6__tzZhqOget, ());
DO_API(const Il2CppAssembly**, _ZNKSt94vNGC, (const Il2CppDomain * domain, size_t * size));

// field
DO_API(int, _ZThn11S, (FieldInfo * field));
DO_API(const char*, _ZNSt62d6RUNHsJs, (FieldInfo * field));
DO_API(size_t, _Znwm39__Z5Vvts5zbwn, (FieldInfo * field));
DO_API(const Il2CppType*, _ZThn685RziUVTpXLw2, (FieldInfo * field));
DO_API(void, _Znwm64rDzQ0jyztCdPn, (FieldInfo * field, void *value));

// method
DO_API(const Il2CppType*, _Znwm19__HdyYsP7XhR38TH8vV, (const MethodInfo * method));
DO_API(const char*, _ZThn99rtSvvPAblA5ivH, (const MethodInfo * method));
DO_API(uint32_t, _ZThn23, (const MethodInfo * method));
DO_API(uint32_t, _ZSt58__Atvw5Jh5mfEJss, (const MethodInfo * method, uint32_t * iflags));
...
DO_API(const Il2CppType*, _Znwm28dg8Lggk, (const MethodInfo * method, uint32_t index));
